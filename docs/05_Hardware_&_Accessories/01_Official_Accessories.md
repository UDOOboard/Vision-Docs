In the [UDOO Shop](https://shop.udoo.org/) you can also find some accessories for the UDOO Vision.
...
When the M.2 dual Ethernet Module Kit accessory is plugged into M.2 Key B slot, the UDOO Vision board will offer three different Gigabit Ethernet ports.
...
<span class="label label-warning">Heads up!</span> Screws, spacers and all other fixtures to mount the M.2 accessories are not included with the accessories items, but they are included when you buy any model of the UDOO Vision board.
...
* Compatible and Direct-connect with UDOO Vision with Windows 10/8.1/8/7, Linux and Android operating system;
...
A beautiful metal case for your UDOO Vision Board.  
...
UDOO Vision METAL CASE includes:
* 1x Metal Top Part;
...
Top and Bottom plexiglass acrylic case for UDOO Vision
...
* [SATA data and power cables for UDOO Vision](https://shop.udoo.org/sata-data-and-power-cables-for-udoo-x86.html) -
SATA data and power cables for UDOO Vision (CN18 and CN30 connectors)
* [Power Supply EU 12V 3A for UDOO Vision](https://shop.udoo.org/accessories/power-adapter-eu.html) -
  * OUTPUT: 12V, 3A
